 ...
 * @author student
 */
public class Win27_控制項陣列1 extends javax.swing.JFrame {
    ...
    private void 取得焦點(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_取得焦點
        ...
        if (tmp == txt[0]) {
            txt[0].setBackground(Color.YELLOW);
        } else {
            txt[0].setBackground(Color.WHITE);
        }

        if (tmp == txt[1]) {
            txt[1].setBackground(Color.YELLOW);
        } else {
            txt[1].setBackground(Color.WHITE);
        }

        if (tmp == txt[2]) {
            txt[2].setBackground(Color.YELLOW);
        } else {
            txt[2].setBackground(Color.WHITE);
        }

        if (tmp == txt[3]) {
            txt[3].setBackground(Color.YELLOW);
        } else {
            txt[3].setBackground(Color.WHITE);
      }
    }//GEN-LAST:event_取得焦點
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Win27_控制項陣列1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Win27_控制項陣列1().setVisible(true);
            }
        });
    }
