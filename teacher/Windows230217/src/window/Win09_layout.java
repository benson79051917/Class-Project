 ...
 * @author Teacher
 */
public class Win09_layout extends javax.swing.JFrame {

    /**
     * Creates new form Win09_layout
     */
    public Win09_layout() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton5, java.awt.BorderLayout.LINE_END);

        jPanel2.setLayout(new java.awt.GridLayout(2, 2, 10, 20));
        ...
        setSize(new java.awt.Dimension(841, 536));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Win09_layout.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Win09_layout().setVisible(true);
            }
        });
    }
